...
/**
 * A Wrapper class to create a Tree-node out of any Comparable object. A
 * WrapperNode is a subclass of AbstractNode. It keeps a reference to the
 * contained object.
 * 
...
public abstract class WrapperNode<T extends WrapperNode<T, E>, E extends Comparable<E>> extends AbstractNode<T> {
	 ...
	 * 
	 * @param object:
	 *            the wrapped object of this node.
	 */
	...
	/**
	 * Overridden version of compareTo to implement Comparable. This method is
	 * implemented in the same way as in AbstractNode, with the following added
	 * behavior: sibblings are ordered by using the compareTo method of the
	 * wrapped object.
	 */
	@Override
