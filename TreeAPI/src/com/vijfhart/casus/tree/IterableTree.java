 ...
 */
public interface IterableTree<T extends Node<T>> extends Iterator<T> {

   /**
    * Returns a TreeComparator to loop through the node elements in a Tree.
    * @return a TreeComparator 
    */
